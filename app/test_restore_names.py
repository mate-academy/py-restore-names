...
def test_restore_names_partial_none_and_present() -> None:
    users: List[Dict[str, Optional[str]]] = [
        ...
        {"first_name": None, "last_name": "Davis", "full_name": "Tom Davis"},
    ]
    restore_names(users)
    assert users == [
        {"first_name": "Alice", "last_name": "Brown", "full_name": "Alice Brown"},
        {"first_name": "Tom", "last_name": "Davis", "full_name": "Tom Davis"},
    ]


def test_restore_names_not_returning_anything() -> None:
    users: List[Dict[str, Optional[str]]] = [{"first_name": None, "last_name": "Lee", "full_name": "Sam Lee"}]
