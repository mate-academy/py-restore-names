...
def test_user_does_not_have_first_name_or_none(user_template):
...
def test_user_first_name_is_none(user_template):
...
def test_func_does_not_return_anything(user_template):
